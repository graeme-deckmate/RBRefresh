...
// For BO3: chosen battlefield for the *next* game (per player).
  ...
  const runEquipAdditionalCostRepro = () => {
    ...
    updateGame((d) => {
      ...
      d.log.unshift(
          `=== Repro end: equipAdditional equipStart=${equipStartOk ? "YES" : "NO"} equipConfirm=${
            equipConfirmOk ? "YES" : "NO"
        ...
        <div className="rb-grid">
          ...
          <div className="rb-panel">
            ...
            <div style={{ marginTop: 8, display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              <button id="rb-run-equip-additional-repro" className="rb-miniButton" disabled={!canActAs(me)} onClick={runEquipAdditionalCostRepro}>Run Equip/Additional Repro</button>
              <button
